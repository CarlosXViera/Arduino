...
void story() {
  Serial.println("Welcome to Glitch Gone Wild!! You work for the bank and things have gone awry. There's a glitch in the system and it seems like you are the only one who has noticed. What will you choose?");
  STATE = 1;
}
